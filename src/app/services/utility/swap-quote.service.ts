...
export class SwapQuoteService {
  ...
  static getPriceImpact(
    ...
    const pool0CrsReserves = poolIn.reserveCrs;
    const pool0SrcReserves = poolIn.reserveSrc;
    const pool1CrsReserves = poolOut.reserveCrs;
    const pool1SrcReserves = poolOut.reserveSrc;
    ...
    if (isSrcToSrc) {
      ...
      const crsPerSrcPoolIn = poolIn.crsPerSrc;
      const crsPerSrcPoolOut = poolOut.crsPerSrc;
      ...
      currentMidPrice = poolIn.srcPerCrs;
      ...
      currentMidPrice = poolIn.crsPerSrc;
